...
console.log('seed the books')
    await Book.create({
        ...
        description: 'A novel written by James Baldwin, published in 1956. The story is set in Paris and explores complex themes such as identity, sexuality, and societal expectations. The narrative follows an American man named David, who is living in Paris and grappling with his own sexual identity and desires',
        status: true,
      });
